...
<div class="hero">
  <div class="container">
    ...
    <div id="essenceCarousel" class="carousel slide" data-bs-ride="carousel">
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img src="<?php echo get_template_directory_uri(); ?>/images/foto1.jpg" class="d-block w-100" alt="Slide 1">
        </div>
        <div class="carousel-item">
          <img src="<?php echo get_template_directory_uri(); ?>/images/foto2.jpg" class="d-block w-100" alt="Slide 2">
        </div>
        <div class="carousel-item">
          <img src="<?php echo get_template_directory_uri(); ?>/images/foto3.jpg" class="d-block w-100" alt="Slide 3">
        </div>
      </div>
    ...
    <section class="latest-products" style="margin-top:2rem">
      <h2 style="text-align:center; color:#ff4ea3;">Latest Products</h2>
        ...
        if($products->have_posts()): while($products->have_posts()): $products->the_post(); ?>
          <div class="product-card">
            <?php if(has_post_thumbnail()): ?>
              <?php the_post_thumbnail('medium', ['class'=>'responsive']); ?>
            <?php endif; ?>
